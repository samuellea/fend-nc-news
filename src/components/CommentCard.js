      ...
      <div className="commentMainContainer-outer">
        <div className="commentMainContainer-inner">
          <div className='commentVoter'>
            <div>
              <Voter votes={comment.votes} comment_id={comment.comment_id} handleVoteInApp={handleVoteInApp} loggedInUser={loggedInUser} key={`voter_${comment.comment_id}`} voterType='smallVoter' />
            </div>
          </div>

          <div className="commentInfo">
            <span className="commentAuthorInfo">{comment.author} </span>
            <span className="commentDateTime"><span ><i className="far fa-clock fa-sm" ></i></span> {toDisplay}</span>
            <span className="commentDeleteButtonContainer">
              {comment.author === username ?
                <button onClick={handleClick} className="commentDeleteButton">
